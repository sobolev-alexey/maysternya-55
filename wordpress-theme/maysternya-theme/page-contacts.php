...
<section class="contact-section" data-testid="contact-page">
    <div class="container">
        <div class="contact-grid">
            <div class="contact-info">
                <h1 class="page-title"><?php _e('GET IN TOUCH', 'maysternya'); ?></h1>
                ...
                <div class="contact-item">
                    <span class="contact-label"><?php _e('Phone', 'maysternya'); ?></span>
                ...
                <?php if ($email) : ?>
                <div class="contact-item">
                    <span class="contact-label"><?php _e('Email', 'maysternya'); ?></span>
                    <p class="contact-value">
                ...
                <?php if ($address) : ?>
                <div class="contact-item">
                    <span class="contact-label"><?php _e('Address', 'maysternya'); ?></span>
                    <p class="contact-value"><?php echo esc_html($address); ?></p>
                </div>
                <?php endif; ?>
                
                <div class="contact-item">
                    <span class="contact-label"><?php _e('Social Media', 'maysternya'); ?></span>
                    <div class="contact-social">
                        ...
                        foreach ($social as $network => $url) {
                            if (!empty($url) && isset($icons[$network])) {
                                printf(
                                    '<a href="%s" class="contact-social-link" target="_blank" rel="noopener noreferrer" aria-label="%s">%s</a>',
                                    esc_url($url),
